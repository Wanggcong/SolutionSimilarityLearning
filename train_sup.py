...
if __name__=='__main__':
    ...
    elif opts.meta_model=='cifar_chain_net6_diff':
        model = plain_net6_diff(2).cuda()
        sup_model =  sup_cifar_chain(class_num,selected_layers)
                    
    elif opts.meta_model=='cifar_chain_net5_leaky_relu':
    ...
    for epoch in range(1, opts.epochs + 1): 
        # myTrainTest.test_retr(query_loader, gal_loader, opts, log_file)  # debug
